...
\section{Beispiele}
Dieses Beispieldokument wurde mit dem \LaTeX-Paket {\tt dmmdbstmpl.sty} erzeugt.
{\tt dmmdbstmpl.sty} definiert Befehle zum Erzeugen von einigen
...
Ihr d\"urft auch gerne englische Arbeiten schreiben. Daf\"ur m\"usst
ihr die Zeile
\verb=\usepackage[german]{dmmdbstmpl}= durch
\verb=\usepackage[]{dmmdbstmpl}= austauschen. Dann hei\ss en
