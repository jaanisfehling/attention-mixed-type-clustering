...
\scalebox{0.8}{
	\begin{tabular}{|p{37mm}|p{27mm}|p{27mm}|p{27mm}|p{27mm}|}
	\hline
	&AE with Column Embeddings&AE with Attention&Transformer N=6&FT-Transformer N=6\\ \hline
...
\end{center}
\caption{Comparison of Normalized Mutual Information between an autoencoder with Column Embeddings, an autoencoder using the attention mechanism, a 6-layer Transformer with an autoencoder and a 6-layer FT-Transformer with an autoencoder on clustering mixed-type datasets using k-means.}
...
\end{center}
\caption{Comparison of Accuracy between an autoencoder with Column Embeddings, an autoencoder using the attention mechanism, a 6-layer Transformer with an autoencoder and a 6-layer FT-Transformer with an autoencoder on clustering mixed-type datasets using k-means.}
...
\scalebox{0.8}{
	...
	\hline
	&&AE with Column Embeddings&Attention&Transformer N=6&FT-Transformer N=6\\ \hline
	&DEC&0.1585&0.1630&0.1642&Val\\
	Abalone&IDEC&0.1501&0.1623&0.1653&Val\\
	&DCN&0.1574&0.1717&0.1671&Val\\ \hline

	&DEC&0.0179&0.0203&0.0446&Val\\
	Auction Verification&IDEC&0.0179&0.0203&0.0444&Val\\
	&DCN&0.0179&0.0203&0.0484&Val\\ \hline

	&DEC&0.0195&0.0023&0.0000&Val\\
	Bank Marketing&IDEC&0.0172&0.0023&0.0000&Val\\
	&DCN&0.0195&0.0023&0.0000&Val\\ \hline

	&DEC&0.7284&0.2185&0.5991&Val\\
	Breast Cancer&IDEC&0.7284&0.2185&0.2244&Val\\
	&DCN&0.7333&0.2185&0.2062&Val\\ \hline

	&DEC&0.0915&0.0663&0.0689&Val\\
	Census Income&IDEC&0.0911&0.0663&0.0689&Val\\
	&DCN&0.0915&0.0663&0.0689&Val\\ \hline

	&DEC&0.0027&0.0000&0.0036&Val\\
	Credit Approval	&IDEC&0.0024&0.0000&0.0036&Val\\
	&DCN&0.0024&0.0000&0.0036&Val\\ \hline

	&DEC&0.1273&0.1599&0.1494&Val\\
	Heart Disease&IDEC&0.1273&0.1599&0.1503&Val\\
	&DCN&0.1268&0.1599&0.1558&Val\\ \hline

	&DEC&0.3878&0.5168&0.2605&Val\\
	Soybean Disease&IDEC&0.3866&0.6532&0.2684&Val\\
	&DCN&0.3930&0.6306&0.2605&Val\\ \hline
	\end{tabular}
}
\end{center}
\caption{Comparison of Normalized Mutual Information of between DEC, DEC with Attention, DEC with a 6-layer Transformer and DEC with a 6-layer FT-Transformer on clustering mixed-type datasets.}
...
\begin{figure}
	...
	\scalebox{0.8}{
		...
		\hline
		&&AE with Column Embeddings&Attention&Transformer N=6&FT-Transformer N=6\\ \hline
		&DEC&0.1621&0.1286&0.1549&Val\\
		Abalone&IDEC&0.1472&0.1384&0.1559&Val\\
		&DCN&0.1676&0.1585&0.1685&Val\\ \hline

		&DEC&0.6676&0.6760&0.6848&Val\\
		Auction Verification&IDEC&0.6676&0.6760&0.6843&Val\\
		&DCN&0.6676&0.6760&0.6569&Val\\ \hline

		&DEC&0.5712&0.7010&0.7602&Val\\
		Bank Marketing&IDEC&0.6162&0.7010&0.7602&Val\\
		&DCN&0.5712&0.7010&0.7602&Val\\ \hline

		&DEC&0.9458&0.7467&0.8990&Val\\
		Breast Cancer&IDEC&0.9458&0.7467&0.7745&Val\\
		&DCN&0.9473&0.7467&0.7350&Val\\ \hline

		&DEC&0.6488&0.7414&0.6284&Val\\
		Census Income&IDEC&0.6486&0.7414&0.6284&Val\\
		&DCN&0.6488&0.7414&0.6284&Val\\ \hline

		&DEC&0.5375&0.5299&0.5467&Val\\
		Credit Approval&IDEC&0.5360&0.5299&0.5467&Val\\
		&DCN&0.5360&0.5299&0.5467&Val\\ \hline

		&DEC&0.2977&0.3445&0.3378&Val\\
		Heart Disease&IDEC&0.2977&0.3445&0.3344&Val\\
		&DCN&0.3010&0.3445&0.3445&Val\\ \hline

		&DEC&0.2544&0.4431&0.2278&Val\\
		Soybean Disease&IDEC&0.2544&0.5552&0.2295&Val\\
		&DCN&0.2669&0.5125&0.2278&Val\\ \hline
		\end{tabular}
	}
	\end{center}
	\caption{Comparison of Accuracy of between DEC, DEC with Attention, DEC with a 6-layer Transformer and DEC with a 6-layer FT-Transformer on clustering mixed-type datasets.}
