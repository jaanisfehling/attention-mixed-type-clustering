...
class KPrototypesDuped(kmodes.KModes):
    ...
    def __init__(self, n_clusters=8, max_iter=100, num_dissim=euclidean_dissim,
        ...
        super().__init__(n_clusters, max_iter, cat_dissim, init,
...
def _k_prototypes_single(Xnum, Xcat, nnumattrs, ncatattrs, n_clusters, n_points,
    ...
    while True:
        ...
        if init_tries == MAX_INIT_TRIES:
            ...
            # Instead of raising an Error here, we just accept the bad initialization 
            # to be able use KPrototypes for the soybean dataset (15 targets)
            # raise ValueError(
            #     "Clustering algorithm could not initialize. "
            #     "Consider assigning the initial clusters manually."
            # )
            print("Clustering algorithm could not initialize.")
            print("Consider assigning the initial clusters manually.")
            break
